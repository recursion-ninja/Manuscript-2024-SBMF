...
\node[flowBig, right=1.55cm of ALG-INI] (FLO-INI) {\parbox[t]{19mm}{%
\AssignInFig{g_i}{\bot},$\;\;\forall i$\\%
\AssignInFig{h_i}{\bot},$\;\;\forall i$\\%
\AssignInFig{m_i}{\bot},$\;\;\forall i$%
}};
\node[flowMed, right=0.50cm of ALG-CRT] (FLO-CRT) {\parbox[t]{32mm}{%
...
\node[flipBig, right=0.50cm of ORC-RMV] (FLO-RMV) {\parbox[t]{11mm}{%
