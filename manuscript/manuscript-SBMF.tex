...
The \Promela encoding \footnote{Source code: \url{https://github.com/recursion-ninja/Manuscript-2024-SBMF/model}} of \CGKAmodN{N} produces all possible states and transitions of TreeKEM, and this representation is then supplied to a model checker for verification.
...
The \Promela model is named \TermLTL{CGKA}, and the state within the model at which \Adversary querries the oracle  \Oracle{corr}{\TermLTL{targetID}} is labeled \TermLTL{move\_corrupt}.
...
Therefore \CGKAmodNT{N}{T} is an apt choice as a comparative baseline from which the effects of the composed abstractions can be measured.
...
Second, \CGKAmodN{N} is utilized to verify \LTLPredicate{FSU} and \LTLPredicate{PCS} for parameters far beyond the the capabilities of \CGKAmodNT{N}{T}.
...
All verification runs of both \CGKAmodN{N} and \CGKAmodNT{N}{T} utilized 1 TiB RAM and \(64\) AMD Opteron Processor 6380 core operating at 2500MHz\footnote{Performed on the American Museum of Natural History scientific computing cluster}.
...
\toprule%
& \multicolumn{2}{c}{\TableHeadFontSize\parbox[][6mm][c]{13mm}{\centering \CGKAmodN{N}}}
& \multicolumn{2}{c}{\TableHeadFontSize\parbox[][6mm][c]{15mm}{\centering \CGKAmodNT{N}{T}}}\\
\\[-2mm]
...
Then verification results produced by  \CGKAmodN{16} for both properties were in the \emph{affirmative}.
