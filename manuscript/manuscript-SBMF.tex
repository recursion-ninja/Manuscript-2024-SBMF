...
The \Promela encoding \footnote{Source code: \url{https://github.com/recursion-ninja/Manuscript-2024-SBMF}} of \CGKAmodN{N} produces all possible states and transitions of TreeKEM, and this representation is then supplied to a model checker for verification.
